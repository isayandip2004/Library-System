...
public class books {
    College.book theBooks[] = new College.book[50];
    public static int count;

    Scanner input = new Scanner(System.in);
    public int compareBookObjects(College.book b1, College.book b2)
    {
    ...
    public void addBook(College.book b)
    {
    ...
    public College.book checkOutBook()
    {
    ...
    public void checkInBook(College.book b)
    {
        for (int i = 0; i < count; i++) {
